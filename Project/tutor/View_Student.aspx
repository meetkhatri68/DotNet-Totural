  ...
  <div class="row">
    ...
    <div class="col-md-4">
        <div class ="input-group">
            ...
            <asp:TextBox class="from-control" placeholder="Search Students" ID="SearchText" runat="server"></asp:TextBox>
              ...
              <div class="col-md-4">
                  ...
                  <div class="card bg-dark text-white text-center">
                      ...
                      <div class="card-body">
                          ...
                          <h5><asp:Label ID="Label8" runat="server" Text='<%# Bind("standard") %>'></asp:Label></h5>
      
                          <small style="font-size: 15px; color: steelblue;">Subject</small>
                          <h5><asp:Label ID="Label4" runat="server" Text='<%# Bind("subject") %>'></asp:Label></h5>
                          ...
                          <h5> <asp:Label ID="Label6" runat="server" Text='<%# Bind("tuitiontype") %>'></asp:Label></h5>
                      </div>

                      <div class="card-footer">
                          <small style="font-size: 15px; color: steelblue;">Tutor Qualification</small>
                          <h4><asp:Label ID="Label7" runat="server" Text='<%# Bind("tutorprefer") %>'></asp:Label></h4>
                      </div>
                  </div>
                  <br />
